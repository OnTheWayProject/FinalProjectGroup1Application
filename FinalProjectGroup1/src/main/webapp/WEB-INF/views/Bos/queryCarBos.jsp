		...
		<ul
			...
			<a
				...
				<div class="sidebar-brand-text mx-3">
					<img src="img/on the way.png" alt="無法顯示圖片" width="80%">
				</div>
			</a>
			...
			<li class="nav-item"><a class="nav-link" href="user.html"> <i
					class="fas fa-user-cog" aria-hidden="true"></i> <span>用戶管理</span>
			</a>
			...
			<li class="nav-item"><a class="nav-link collapsed" href="#"
				...
				aria-controls="collapse1"> <i class="fas fa-house-user"
					aria-hidden="true"></i> <span>住宿商品管理</span>
			</a>
				<div id="collapse1" class="collapse"
					aria-labelledby="headingUtilities" data-parent="#accordionSidebar">
					<div class="bg-white py-2 collapse-inner rounded">
						<!-- <h6 class="collapse-header">Custom Utilities:</h6>-->
						<a class="collapse-item" href="AllStay.html">全部住宿</a> <a
							class="collapse-item" href="Stay.html">私人民宿</a>
			...
			<li class="nav-item"><a class="nav-link collapsed" href="#"
				...
				aria-controls="collapse2"> <i class="fas fa-car-alt"
					aria-hidden="true"></i> <span>交通商品管理</span>
			</a>
				<div id="collapse2" class="collapse" aria-labelledby="headingPages"
					data-parent="#accordionSidebar">
					<div class="bg-white py-2 collapse-inner rounded">
						<!--  <h6 class="collapse-header">Login Screens:</h6> -->
						<a class="collapse-item" href="car.html">租車</a> <a
							class="collapse-item" href="train.html">火車票</a>
			...
			<li class="nav-item"><a class="nav-link collapsed"
				href="Event.html" data-toggle="collapse" data-target="#collapse3"
				aria-expanded="true" aria-controls="collapse3"> <i
					class="far fa-calendar-check " aria-hidden="true"></i> <span>活動商品管理</span>
			</a>
				<div id="collapse3" class="collapse" aria-labelledby="headingPages"
					data-parent="#accordionSidebar">
					<div class="bg-white py-2 collapse-inner rounded">
						<!--  <h6 class="collapse-header">Login Screens:</h6> -->
						<a class="collapse-item" href="#">特色體驗</a> <a
							class="collapse-item" href="SpEvent.html">城市尋寶</a>

					</div>
				</div></li>

			<!-- Nav Item - Blog -->
			<li class="nav-item"><a class="nav-link" href="<c:url value='/queryCarBos' />">
					<i class="fas fa-clipboard-list" aria-hidden="true"></i> <span>部落格管理</span>
			</a></li>
